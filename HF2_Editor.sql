CREATE TABLE [dbo].[Ugyfel](
	...
	[SZULEV] [int] MASKED WITH (Function = 'random(100,2000)') NULL,
	[NEM] [nvarchar](1) MASKED WITH (Function = 'default()') NULL,
	[CIM] [nvarchar](255) MASKED WITH (Function = 'partial(2,"XXXX",2)') NULL,
...
ALTER TABLE Ugyfel
ADD LOGINHASH NVARCHAR(64);

--!!!!!!!!!!!!

UPDATE Ugyfel
SET LOGINHASH = CONVERT(NVARCHAR(64), HASHBYTES('SHA2_256', [LOGIN]), 2);
